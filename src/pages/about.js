        ...
        <Layout className="bg-main-background w-full h-full">
            ...
            <div className="z-10 font-open-sans">
                <div>
                    ...
                    <h1 className="text-3xl text-center text-text-main mt-9">Hello there! 👋</h1>
                    <article className="max-w-xl">
                        <div className="text-lg text-center text-text-main mt-2 whitespace-pre-wrap mx-5 sm:mx-9">
